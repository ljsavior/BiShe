...
namespace MyApplication
{
    class Constant
    {
        ...
        public const String SERVIER_GET_TRAINING_QUERY_URL = SERVER_HOST + "/client/training/get.json";
        ...
        public const String SERVER_POSTURE_QUERY_URL = SERVER_HOST + "/posture/get.json";
